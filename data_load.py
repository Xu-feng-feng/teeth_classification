...
class DataLoader(object):
  ...
  def __init__(self, train_data_path, valid_data_path, test_data_path,
    ...
    # self.label2id = {'1': 0, '2': 1, '3': 2, '4': 3, '5': 4, '6': 5, '7': 6, '8': 7, '9': 8, '10': 9, '11': 10, '12': 11, '13': 12, '14': 13, '15': 14, '16': 15}
    # self.label2id = {'1': 0, '7': 1, '11': 2}
...
#       data = []
#       label = []
#       print("Data file path:", data_path)  # Add this line
#       with open(data_path, "r") as f:
#           lines = f.readlines()
#           print("Number of lines read from file:", len(lines))  # Add this line
...
#       length = len(label)
#       print(data_type + "_data_length:" + str(length))
#       print("Number of data samples:", len(data))  # Add this line
#       return data, label, length
